...
const Island: React.FC<IslandProps> = ({
	...
	useEffect(() => {
		...
		document.addEventListener('pointerdown', handlePointerDownListener);
		document.addEventListener('pointerup', handlePointerUpListener);
		document.addEventListener('pointermove', handlePointerMoveListener);
		document.addEventListener('keydown', handleKeyDown);

		return () => {
			document.removeEventListener('pointerdown', handlePointerDownListener);
			document.removeEventListener('pointerup', handlePointerUpListener);
			document.removeEventListener('pointermove', handlePointerMoveListener);
